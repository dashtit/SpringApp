...
import com.titowecz.appList.exception.DocumentNotFoundException;
import com.titowecz.appList.exception.FileStorageException;
import com.titowecz.appList.exception.MyFileNotFoundException;
import com.titowecz.appList.exception.MyNotOwnerException;
...
public class DocumentServiceImpl implements DocumentService {
  ...
  public String storeFile(MultipartFile file) {
   ...
   //   if (fileName.matches("([^\\s]+(\\.(?i)(exe|bin|iso|msi/xpi/dmg))$)")) {
